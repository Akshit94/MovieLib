...
import com.example.jainsaab.movielib.AddFavouriteTask;
...
public class MoviesWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            views.setRemoteAdapter(R.id.widget_grid,
                    new Intent(context, MoviesWidgetRemoteViewsService.class));

            Intent clickIntentTemplate = new Intent(context, MoviesActivity.class);
    ...
    public void onReceive(@NonNull Context context, @NonNull Intent intent) {
        ...
        if (AddFavouriteTask.ACTION_DATA_UPDATED.equals(intent.getAction())) {
